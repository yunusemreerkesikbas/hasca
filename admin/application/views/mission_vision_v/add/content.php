			...
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						...
						<form action="<?php echo base_url("mission_vision/save"); ?>" method="post" enctype="multipart/form-data">
							<div class="mb-3 row">
								<label for="example-text-input" class="col-md-2 col-form-label">Vizyon & Misyon Başlık</label>
								<div class="col-md-10">
