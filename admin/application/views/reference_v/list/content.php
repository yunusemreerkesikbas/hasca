	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-12">
				<div class="page-title-box d-sm-flex align-items-center justify-content-between">
					<h4 class="mb-sm-0 font-size-18">Referanslar</h4>
		...
		<?php if (empty($items)): ?>
			<div class="alert alert-warning alert-dismissible fade show" role="alert">
					Burada henüz bir veri yok, eklemek için <a href="<?php echo base_url("reference/add")?>">buraya tıklayınız</a>
						...
						<div class="row mb-2">
							...
							<div class="col-sm-8">
								<div class="text-sm-end">
									<a href="<?php echo base_url("reference/add")?>"
											class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2"><i
												class="mdi mdi-plus me-1"></i> Yeni marka ekle
									</a>
								</div>
							</div><!-- end col-->
						</div>
						...
						<div class="table-responsive col-md-12">
							<table class="table align-middle table-nowrap table-check content-container">
								...
								<tr>
									...
									<th class="align-middle">Firma adı</th>
									...
									<tr>
										...
										<td>
											<div class="d-flex gap-3">
												<a href="<?php echo base_url("reference/update_form/$item->id"); ?>" class="text-success"><i class="mdi mdi-pencil font-size-18"></i></a>

												<a data-url="<?php echo base_url("reference/delete/$item->id"); ?>" class="text-danger remove-btn"  style="cursor: pointer">
