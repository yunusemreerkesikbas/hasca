			...
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						...
						<h4 class="card-title">Ürün grubu ekle</h4>
						<p class="card-title-desc">Lütfen bilgileri giriniz</p>
						<form action="<?php echo base_url("product_category/save"); ?>" method="post" enctype="multipart/form-data">
							<div class="mb-3 row">
								<label for="example-text-input" class="col-md-2 col-form-label">Kategori ismi</label>
								<div class="col-md-10">
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="mt-3">
										<label >Kapak fotoğrafı seçiniz</label>
