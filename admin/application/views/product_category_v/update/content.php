...
<!--						<p class="card-title-desc">Lütfen bilgileri giriniz</p>-->
						<form action="<?php echo base_url("product_category/update/$item->id"); ?>" method="post" enctype="multipart/form-data">
							<div class="mb-3 row">
								<label for="example-text-input" class="col-md-2 col-form-label">Ürün grubu adı</label>
								<div class="col-md-10">
