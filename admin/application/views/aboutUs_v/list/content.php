	...
	<div class="container-fluid">
		...
		<?php if (empty($items)): ?>
			<div class="alert alert-warning alert-dismissible fade show" role="alert">
					Burada henüz bir veri yok, eklemek için <a href="<?php echo base_url("aboutUs/add")?>">buraya tıklayınız</a>
						...
						<div class="row mb-2">
							...
							<div class="col-sm-8">
								<div class="text-sm-end">
									<a href="<?php echo base_url("aboutUs/add")?>"
									...
									<tr>
										...
										<td>
											<div class="form-check form-switch form-switch-lg mb-3 row d-flex" style="padding-left: 0"  dir="ltr">
												...
												<div class="col-md-10" >
													<input
															data-url="<?php echo base_url("aboutUs/isActiveSetter/$item->id"); ?>"
										...
										<td>
											<div class="d-flex gap-3">
												<a href="<?php echo base_url("aboutUs/update_form/$item->id"); ?>" class="text-success"><i class="mdi mdi-pencil font-size-18"></i></a>

												<a data-url="<?php echo base_url("aboutUs/delete/$item->id"); ?>" class="text-danger remove-btn"  style="cursor: pointer">
