...
(function (global, factory) {
  ...
  class MetisMenu {
    ...
    init() {
      ...
      el.addClass(ClassName.METIS); // list metismenu class to element

      el.find(`${conf.parentTrigger}.${ClassName.ACTIVE}`)
        .children(conf.triggerElement)
        .attr('aria-expanded', 'true'); // list attribute aria-expanded=true the trigger element
      ...
      el.find(`${conf.parentTrigger}.${ClassName.ACTIVE}`)
        .parents(conf.parentTrigger)
        .children(conf.triggerElement)
        .attr('aria-expanded', 'true'); // list attribute aria-expanded=true the triggers of all parents
