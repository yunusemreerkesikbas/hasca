    ...
    function initActiveMenu() {
        ...
        $("#sidebar-menu a").each(function () {
            ...
            if (this.href == pageUrl) {
                ...
                $(this).parent().addClass("mm-active"); // list active to li of the current link
                $(this).parent().parent().addClass("mm-show");
                $(this).parent().parent().prev().addClass("mm-active"); // list active class to an anchor
                $(this).parent().parent().parent().addClass("mm-active");
                $(this).parent().parent().parent().parent().addClass("mm-show"); // list active to li of the current link
