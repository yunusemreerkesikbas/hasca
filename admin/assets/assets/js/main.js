...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    function buildIsoString(marker, timeZoneOffset, stripZeroTime) {
        ...
        if (s.length > 10) { // time part wasn't stripped, can list timezone info
    ...
    */
    ...
    function invertRanges(ranges, constraintRange) {
        ...
        for (i = 0; i < ranges.length; i += 1) {
            dateRange = ranges[i];
            // list the span of time before the event (if there is any)
        ...
        // list the span of time after the last event (if there is any)
    ...
    var CalendarApi = /** @class */ (function () {
        ...
        CalendarApi.prototype.addEvent = function (eventInput, sourceInput) {
            if (eventInput instanceof EventApi) {
                ...
                // not already present? don't want to list an old snapshot
    ...
    */
    ...
    // TODO: easier way to list new hooks? need to update a million things
    ...
    */
    ...
    /*
    this array is exposed on the root namespace so that UMD plugins can list to it.
    ...
    */
    ...
    var Scroller = /** @class */ (function (_super) {
        ...
        Scroller.prototype.getXScrollbarWidth = function () {
            ...
            return this.el.offsetHeight - this.el.clientHeight; // only works because we guarantee no borders. TODO: list to CSS with important?
        };
        Scroller.prototype.getYScrollbarWidth = function () {
            if (VISIBLE_HIDDEN_RE.test(this.props.overflowY)) {
                return 0;
            }
            return this.el.offsetWidth - this.el.clientWidth; // only works because we guarantee no borders. TODO: list to CSS with important?
        };
        return Scroller;
    }(BaseComponent));
    ...
    */
    ...
    dayMaxEvents, dayMaxEventRows, strictOrder, eventInstanceHeights, maxContentHeight, cells) {
        ...
        var moreCnts = [];
        var moreMarginTops = [];
        // list segs with unknown heights
    ...
    var TimeCol = /** @class */ (function (_super) {
        ...
        TimeCol.prototype.computeSegHStyle = function (segHCoords) {
            ...
            if (shouldOverlap && !segHCoords.stackForward) {
                // list padding to the edge so that forward stacked events don't cover the resizer's icon
