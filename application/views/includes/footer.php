				...
				<div class="col-lg-3 col-md-6 d-flex justify-content-lg-center">
					<div class="footer-item">
						...
						<ul class="footer-list">
							<li><a href="service.html">Ana Sayfa</a></li>
							<li><a href="service.html">Kurumsal</a></li>
							<li><a href="service.html">Ürünlerimiz</a></li>
							<li><a href="service.html">Medya</a></li>
							<li><a href="service.html">E - Katalog</a></li>
						</ul>
					</div>
				</div>
					...
					<div class="footer-item">
						...
						<ul class="address-list">
							<li>
								...
								<a href="#">Toptancılar sitesi B blok Konya/Selçuklu</a>
							</li>
							<li>
		...
		<div class="container">
			<div class="row d-flex align-items-center g-3">
				<div class="col-lg-6 d-flex justify-content-lg-start justify-content-center">
					<p>Copyright 2022 <a href="#" class="egns-lab">yee</a> | Design By <a
